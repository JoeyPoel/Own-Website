        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <div className="flex flex-col gap-4 mt-4">
              <div className="flex gap-4 p-5 rounded-2xl bg-white/60 border border-white/70 shadow-sm">
          ...
          >
            <div className="relative group max-w-sm lg:max-w-none">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/70 shadow-xl bg-white/80 p-3">
                <img 
                  src="/joey.jpg" 
