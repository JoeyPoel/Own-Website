...
async function main() {
  ...
  const projects = [
    ...
    {
      title: 'Accessible AI Zoo Guide (DEPT® Collaboration)',
      category: 'mobile',
      tagline: 'Inclusive native Android app integrating custom computer vision and conversational AI.',
      stack: ['Kotlin', 'Jetpack Compose', 'OpenAI API', 'Firebase', 'Mapbox'],
      highlights: [
        'Deep integration with Android TalkBack accessibility tools',
        'Scalable high-contrast color styling for visual assistance',
        'Hybrid on-device and cloud multimodal AI image recognition models',
      ],
      image: '/projects/agentic_terminal.jpg',
    },
    {
    ...
    {
      title: 'Talent Mobility Matching Engine',
      category: 'automation',
      tagline: 'Natural language processing microservice modeling holistic competency matching for HR.',
      stack: ['Python', 'FastAPI', 'spaCy / NLP'],
      highlights: [
        'Ingests unstructured manager feedback notes and HR parameters',
        'Extracts skill vectors and maps candidate alignment dynamically',
        'Built as Joey\'s Bachelor Thesis Proof-of-Concept',
      ],
      image: '/projects/agentic_terminal.jpg',
    },
  ]
